...
class MySQL:
    ...
    def searchTweetsByHour(self):
        ...
        result = {'amount_hour': amount_hour, 'amount_avg': amount_avg,
                  'amount_spike': amount_spike, 'sentiment_hour': sentiment_hour, 'sentiment_avg': sentiment_avg, 'sentiment_spike': sentiment_spike}
        return result
